...
export default async function createAnswerCollection() {
    ...
    // Create indexes
    await Promise.all([
      databases.createIndex(db, answerCollection, "titleIndex", IndexType.Fulltext, ["title"], ["asc"]),
      databases.createIndex(db, answerCollection, "tagsIndex", IndexType.Fulltext, ["tags"], ["asc"]),
    ]);
